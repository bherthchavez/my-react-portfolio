...
const Navbar = () => {
  ...
  return (
  <div>
    <div className='md:px-[60px] sm:px-[20px] z-20 fixed flex justify-between items-end h-[130px] w-full mx-auto  my-2 text-white bg-[#343943]'>
      ...
      <ul className={nav ? 'fixed z-20 left-0 top-0 w-[70%] h-full border-r shadow-2xl border-r-gray-600 bg-[#343943] opacity-[98%] ease-in-out duration-300' : 'ease-in-out duration-300 fixed left-[-100%]'}>
        <Link to='home' smooth={true} duration={500}>
