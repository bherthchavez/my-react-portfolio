...
export const aboutMe = `I am a passionate IT professional with 8 years of experience spanning software development, system administration, business analysis, and web/UI design. My career started as a Software Developer in the Philippines before moving to Qatar, where I gained multi-industry experience across four companies, sharpening both my technical and analytical skills. Today, I specialize in MERN stack development (React.js, Node.js, MongoDB, Express.js), with strong expertise in React.js with TypeScript, building responsive, scalable, and user-focused applications.
